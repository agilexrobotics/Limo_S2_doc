...
![](../s2-doc/s2_image/rviz_1.png)

![](../s2-doc/s2_image/rviz_2.png)

Fixed frame选择camera_link

![](../s2-doc/s2_image/rviz_3.png)

image组件填入对应的话题获取rgb图片

![](../s2-doc/s2_image/rviz_4.png)

完成上述操作之后就能在Image窗口看到摄像头拍摄的画面了。

![](../s2-doc/s2_image/rviz_5.png)

如果想要查看点云数据，点击add添加DepthCloud组件

![](../s2-doc/s2_image/rviz_6.png)

fixed frame选择camera_link, DepthCloud组件选择对应的话题

![](../s2-doc/s2_image/rviz_7.png)

显示深度图

![](../s2-doc/s2_image/rviz_8.png)
